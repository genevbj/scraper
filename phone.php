...
function cookie_baker($cf)
{
    ...
    {
	if(($line[0] != '#' || strpos($line, '#HttpOnly_') === 0 ) && substr_count($line, "\t") == 6) 
	{
...
//	$headers[] =    "Cookie: PHPSESSID=b8ntq3qa3n43fkl8g0fpokhdu3; mobile_default=desktop; layerappsSeen=1; pt=152d542362f614e2fdb144a80ec8b800d0f68c994c66187863daf1dc5ad694744d75c33ee747e82c55c2106d25d9e7d8da0dd3bb1f93d4c939c2a3327ad5f140; smart_top=1; from_detail=1; mp_ccb9dc9ef29ec6fed030230b5f8d16e9_mixpanel=%7B%22distinct_id%22%3A%20%2215c3fc7f0d90-038ab020d22c05-3060750a-1fa400-15c3fc7f0e3340%22%2C%22%24search_engine%22%3A%20%22google%22%2C%22%24initial_referrer%22%3A%20%22https%3A%2F%2Fwww.google.ru%2F%22%2C%22%24initial_referring_domain%22%3A%20%22www.google.ru%22%7D; onap=15c3fc7eccdx1b5ee172-9-15c62825924x7f35f108-2-1496303193";
	$headers[] = "Host: olx.uz";
...
$parser = new Parser_OLX($s_options);

$url='http://olx.uz/obyavlenie/afrika-lakkasi-chavoklari-IDvA3Z.html';

$url_id=preg_replace('/.+-ID(.+)\.html.*/i','\\1',$url);

$u->add_options([CURLOPT_REFERER => 'http://google.com',    CURLOPT_COOKIEJAR	   => 'cookie.txt', CURLOPT_COOKIEFILE	   => 'cookie.txt', CURLOPT_HEADER => 1, ]);
...
preg_match_all('/^Set-Cookie:\s*([^;]*)/mi', $h, $m);
...
foreach($m[1] as $item) {
	...
	$headers[]="Cookie: ".$cookies."layerappsSeen=1; smart_top=1; from_detail=1; mp_ccb9dc9ef29ec6fed030230b5f8d16e9_mixpanel=%7B%22distinct_id%22%3A%20%2215c3fc7f0d90-038ab020d22c05-3060750a-1fa400-15c3fc7f0e3340%22%2C%22%24search_engine%22%3A%20%22google%22%2C%22%24initial_referrer%22%3A%20%22https%3A%2F%2Fwww.google.ru%2F%22%2C%22%24initial_referring_domain%22%3A%20%22www.google.ru%22%7D; onap=15c3fc7eccdx1b5ee172-9-15c62825924x7f35f108-2-1496303193";
	$headers[]="X-Requested-With: XMLHttpRequest";
	$s_options['headers'] = $headers;


$u2=new URL_Helper($s_options);



$u2->add_options([CURLOPT_REFERER => $url, ]);
$ph = $u2->load('http://olx.uz/ajax/misc/contact/phone/'.$url_id.'/?pt='.$e['@PHONE_TOKEN'][0]);
